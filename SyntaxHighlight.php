...
class SyntaxHighlight {
    ...
    private static function highlight_html($s) {
        $out = '';
     ...
     */
    private static function highlight_css($s) {
        // helper function
     ...
     */
    private static function highlight_generic($s) {
        ...
        $regexp = array(
            ...
            // PHP/Perl/Powershell-Style Vars: $var, %var, @var
            '/(?<!\w)(
                (\$|\%|\@)(\-&gt;|\w)+
            )(?!\w)/ix'
